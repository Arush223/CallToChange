...
function Page() {
  ...
  return (
    <div className="relative h-screen bg-black overflow-hidden">
      ...
      >
        <h1
          className={`text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500 title overflow-visible text-center`}
        >
          Over {percentage}% of companies use LLMs.
        </h1>
        <div className="mt-5">
          <p
            className={`text-center p-2 text-lg font-semibold text-white animate-slide-up-2  ${
              showText
        ...
        <div className="mt-16 flex flex-row items-center justify-center space-x-8 ">
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-white mt-2">
              LLMs (Large Language Models) use a significant amount of energy to
              train.
            </p>
          </div>
          <div className="flex flex-col items-center space-y-4">
            ...
            />
            <p className="text-white mt-2">
              These LLMs are trained on large databases that draw data from
              millions of sources.
            </p>
          </div>
          <div className="flex flex-col items-center space-y-4">
            ...
            />
            <p className="text-white mt-2">
              Training LLMs use a lot of energy, which results in increased
              carbon emissions.
            </p>
          </div>
        </div>
