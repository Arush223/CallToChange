  ...
  return (
    <div className="relative h-screen bg-black text-white text-left overflow-hidden px-32">
      ...
      <div className="text-center mt-12 mb-8">
        <h1 className="text-5xl text-center font-extrabold overflow-visible p-2">
          {" "}
          We Are
        </h1>
      </div>
      ...
      <div className="text-center mt-8">
        <h1 className="text-white-500  text-xl">
          Team Liquid Death, consisting of (left to right) Aarush Jagtap, Aditya
          Kakarla, and Ganesh Kumarappan. Originating from the farms of
